...
/**
 * 09/26/2008 Nestor Urquiza eliminated the test portion of the class which you can find in the original
 * at: http://josephoconnell.com/java/xss-html-filter/source/
 *
