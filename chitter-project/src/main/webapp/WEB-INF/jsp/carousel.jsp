    ...
    <div id="myCarousel" class="carousel slide">
        ...
        <div class="carousel-inner">
            <div class="active item">
                <img alt="" src="http://chitter.com/static/images/carousel/registration.jpg">
            ...
            <div class="item">
                <img alt="" src="http://chitter.com/static/images/carousel/profile.jpg">
                <div class="carousel-caption">
            ...
            <div class="item">
                <img alt="" src="http://chitter.com/static/images/carousel/cheet.jpg">
                <div class="carousel-caption">
                    <h4>Make Cheets </h4>
            ...
            <div class="item">
                <img alt="" src="http://chitter.com/static/images/carousel/search_follow.jpg">
                <div class="carousel-caption">
            ...
            <div class="item">
                <img alt="" src="http://chitter.com/static/images/carousel/followers.jpg">
                <div class="carousel-caption">
            ...
            <div class="item">
                <img alt="" src="http://chitter.com/static/images/carousel/favourite.jpg">
                <div class="carousel-caption">
